        ...
        <div className="card-grid card-grid-3">
          <A v={scaleIn} d={2}>
            <div className="headline-card headline-card-with-img">
              <img src={`${import.meta.env.BASE_URL}headline-1.png`} alt="Bill Gates headline" />
              <p>"AI will replace doctors<br />within 5 years"</p>
            </div>
          </A>
          <A v={scaleIn} d={3}>
            <div className="headline-card headline-card-with-img">
              <img src={`${import.meta.env.BASE_URL}headline-2.png`} alt="ChatGPT healthcare headline" />
              <p>"ChatGPT to save healthcare $360&nbsp;billion"</p>
            </div>
          </A>
          <A v={scaleIn} d={4}>
            <div className="headline-card headline-card-with-img">
              <img src={`${import.meta.env.BASE_URL}headline-3.png`} alt="AI healthcare predictions headline" />
